...
__attribute__((used)) static struct FtState move_logic[] = {
		...
		// State: 373 - SpecialHi
		{
			...
			Gnw_SpecialHi_IASAcb, // IASACallback
		...
		// State: 374 - SpecialAirHi
		{
			...
			Gnw_SpecialAirHi_IASAcb, // IASACallback
		...
		// State: 375 - SpecialLw
		{
			...
			Gnw_SpecialLw_IASAcb, // IASACallback
		...
		// State: 378 - SpecialAirLw
		{
			...
			Gnw_SpecialAirLw_IASAcb, // IASACallback
